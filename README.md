...
**Sources:**
We tried to find free online sources for all references, and list sources that informed Monique's thinking in the bibliography. Most of the Aristotle readings are on Perseus (Tufts), but Wikisource filled in some blanks. However, this isn't a critical edition -- we don't KNOW which exact source Stein was thinking about. Rather, we KNOW she was thinking philosophically and using philosophical words. Many entries thus point in multiple directions, which, taken together, further uncover the stratified and wide-ranging intertextual logic of her work.      
